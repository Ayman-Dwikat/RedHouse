...
class _HomeInformationState extends State<HomeInformation> {
  ...
  Future<void> _showAvailableDates() async {
    ...
    DateTime lastDate =
        DateTime(currentDate.year, currentDate.month, currentDate.day + 30);
                        ...
                        LineChartBarData(
                          ...
                          spots: List.generate(
                            ...
                            (index) {
                              ...
                              return widget.property.listingType ==
                                          "For daily rent" ||
                                      widget.property.listingType ==
                                          "For monthly rent"
                                  ? FlSpot(year.toDouble(),
                                      (Random().nextInt(4) + 2) * 500)
                                  : FlSpot(year.toDouble(),
                                      (Random().nextInt(5) + 2) * 50000);
                            },
                          ),
